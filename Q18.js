...
var beauitfullplace = ["Maldives", "Costa Rica", "Tanzania", "United States", "Iceland"];
...
console.log(__spreadArray([], beauitfullplace.sort(), true));
...
console.log(__spreadArray([], beauitfullplace.sort().reverse(), true));
